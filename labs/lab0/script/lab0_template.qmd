...
car_model<-select(car_data,Model,Mileage)

# Select Manufacturer, Price, and Fuel type
car_shop<-select(car_data,Manufacturer,Price,'Fuel type')

# Challenge: Select all columns EXCEPT Engine Size
car_no_engine<-select(car_data,-'Engine size')
...
car_year<- rename(car_data,year='Year of manufacture')
...
**Your answer:** blanks in 'Year of manufacture'
...
mutate(car_data,age='2025-year of manufacture')
